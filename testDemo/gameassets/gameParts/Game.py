...
class Game:
    ...
    def add_tower(self, name):
        ...
        object_list = [ArcherTower(x, y, self.appleprice / 8 ,self.appleprice / 3000), ArcherTowerShort(x, y, self.googleprice / 12 ,self.googleprice / 2000), DamageTower(x, y), RangeTower(x, y ,self.twitterprice / 1000)]
